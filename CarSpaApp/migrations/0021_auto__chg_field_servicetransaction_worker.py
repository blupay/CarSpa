...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceTransaction.worker'
        db.alter_column(u'CarSpaApp_servicetransaction', 'worker_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['CarSpaApp.Worker']))

    def backwards(self, orm):

        # Changing field 'ServiceTransaction.worker'
        db.alter_column(u'CarSpaApp_servicetransaction', 'worker_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['CarSpaApp.Worker']))

    models = {
        u'CarSpaApp.car_number': {
            'Meta': {'object_name': 'Car_number'},
            'car_number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'customer'", 'to': u"orm['CarSpaApp.Customer']"}),
        ...
        u'CarSpaApp.customer': {
            ...
            'customer_ID': ('django.db.models.fields.CharField', [], {'max_length': '10', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'CarSpaApp.servicetransaction': {
            ...
            'worker': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'worker'", 'null': 'True', 'to': u"orm['CarSpaApp.Worker']"})
        },
