...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'CarSpaApp_transaction', 'customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['CarSpaApp.Customer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.customer'
        db.delete_column(u'CarSpaApp_transaction', 'customer_id')
