...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.tel_number'
        db.add_column(u'CarSpaApp_customer', 'tel_number',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.tel_number'
        db.delete_column(u'CarSpaApp_customer', 'tel_number')
