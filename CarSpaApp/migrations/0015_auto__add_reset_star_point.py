...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Reset_Star_Point'
        db.create_table(u'CarSpaApp_reset_star_point', (
        ...
        db.send_create_signal(u'CarSpaApp', ['Reset_Star_Point'])


    def backwards(self, orm):
        # Deleting model 'Reset_Star_Point'
        db.delete_table(u'CarSpaApp_reset_star_point')
