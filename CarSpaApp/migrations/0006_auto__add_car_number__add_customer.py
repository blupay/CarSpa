...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Car_number'
        db.create_table(u'CarSpaApp_car_number', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('car_number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
        ...
        db.send_create_signal(u'CarSpaApp', ['Car_number'])

        # Adding model 'Customer'
        db.create_table(u'CarSpaApp_customer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer_ID', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('Full_Name', self.gf('django.db.models.fields.CharField')(default='Yaw', max_length=60)),
        ...
        db.send_create_signal(u'CarSpaApp', ['Customer'])


    def backwards(self, orm):
        # Deleting model 'Car_number'
        db.delete_table(u'CarSpaApp_car_number')

        # Deleting model 'Customer'
        db.delete_table(u'CarSpaApp_customer')
