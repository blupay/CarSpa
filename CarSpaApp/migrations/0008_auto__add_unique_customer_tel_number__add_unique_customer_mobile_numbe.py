...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Customer', fields ['tel_number']
        db.create_unique(u'CarSpaApp_customer', ['tel_number'])

        # Adding unique constraint on 'Customer', fields ['mobile_number']
        db.create_unique(u'CarSpaApp_customer', ['mobile_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Customer', fields ['mobile_number']
        db.delete_unique(u'CarSpaApp_customer', ['mobile_number'])

        # Removing unique constraint on 'Customer', fields ['tel_number']
        db.delete_unique(u'CarSpaApp_customer', ['tel_number'])
