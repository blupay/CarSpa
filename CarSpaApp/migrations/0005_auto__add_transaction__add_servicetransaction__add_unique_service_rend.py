...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'CarSpaApp_transaction', (
            ...
            ('attendance', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ...
        db.send_create_signal(u'CarSpaApp', ['Transaction'])

        # Adding model 'ServiceTransaction'
        db.create_table(u'CarSpaApp_servicetransaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('servcTransID', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('worker', self.gf('django.db.models.fields.related.ForeignKey')(related_name='worker', to=orm['CarSpaApp.Worker'])),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='service', to=orm['CarSpaApp.Service_Rendered'])),
            ('Transxn', self.gf('django.db.models.fields.related.ForeignKey')(related_name='transaction', to=orm['CarSpaApp.Transaction'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'CarSpaApp', ['ServiceTransaction'])

        # Adding unique constraint on 'Service_Rendered', fields ['service_Name', 'car_type']
        db.create_unique(u'CarSpaApp_service_rendered', ['service_Name_id', 'car_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Service_Rendered', fields ['service_Name', 'car_type']
        db.delete_unique(u'CarSpaApp_service_rendered', ['service_Name_id', 'car_type_id'])

        # Deleting model 'Transaction'
        db.delete_table(u'CarSpaApp_transaction')

        # Deleting model 'ServiceTransaction'
        db.delete_table(u'CarSpaApp_servicetransaction')
