...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Star_Point'
        db.create_table(u'CarSpaApp_star_point', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CarSpaApp.Customer'])),
            ('point', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal(u'CarSpaApp', ['Star_Point'])

        # Adding field 'ServiceTransaction.star_point'
        db.add_column(u'CarSpaApp_servicetransaction', 'star_point',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['CarSpaApp.Star_Point']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Star_Point'
        db.delete_table(u'CarSpaApp_star_point')

        # Deleting field 'ServiceTransaction.star_point'
        db.delete_column(u'CarSpaApp_servicetransaction', 'star_point_id')
    ...
    models = {
        ...
        u'CarSpaApp.servicetransaction': {
            ...
            'star_point': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['CarSpaApp.Star_Point']"}),
        ...
        u'CarSpaApp.star_point': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'point': ('django.db.models.fields.FloatField', [], {}),
