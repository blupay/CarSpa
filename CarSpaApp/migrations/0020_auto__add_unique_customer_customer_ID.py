...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Customer', fields ['customer_ID']
        db.create_unique(u'CarSpaApp_customer', ['customer_ID'])


    def backwards(self, orm):
        # Removing unique constraint on 'Customer', fields ['customer_ID']
        db.delete_unique(u'CarSpaApp_customer', ['customer_ID'])
