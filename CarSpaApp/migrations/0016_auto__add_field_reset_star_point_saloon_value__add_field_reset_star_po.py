...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reset_Star_Point.saloon_value'
        db.add_column(u'CarSpaApp_reset_star_point', 'saloon_value',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Reset_Star_Point.suv_value'
        db.add_column(u'CarSpaApp_reset_star_point', 'suv_value',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reset_Star_Point.saloon_value'
        db.delete_column(u'CarSpaApp_reset_star_point', 'saloon_value')

        # Deleting field 'Reset_Star_Point.suv_value'
        db.delete_column(u'CarSpaApp_reset_star_point', 'suv_value')
    ...
    models = {
        ...
        u'CarSpaApp.reset_star_point': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'saloon_value': ('django.db.models.fields.FloatField', [], {}),
            'suv_value': ('django.db.models.fields.FloatField', [], {}),
